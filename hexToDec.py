...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.HexText = QtWidgets.QTextBrowser(self.centralwidget)
        self.HexText.setGeometry(QtCore.QRect(150, 10, 371, 51))
        self.HexText.setObjectName("HexText")
        self.DecText = QtWidgets.QTextBrowser(self.centralwidget)
        ...
        self.LegnthText = QtWidgets.QTextBrowser(self.centralwidget)
